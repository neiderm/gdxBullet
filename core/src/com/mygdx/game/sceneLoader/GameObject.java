...
// tmp test
//                ModelInfo p0ModelInfo = GameWorld.getInstance().getSceneData().modelInfo.get(objectName);
  //              if (null != p0ModelInfo){
    //                String strAnimationNode = p0ModelInfo.animationNode;
      //          }
